  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small><?php echo lang('Company'); ?></small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><?php echo lang('Manage Company Information'); ?></h3>
            </div>
            <form role="form" action="<?php base_url('company/update') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="service_charge_value"><?php echo lang('Charge Amount %'); ?></label>
                ...
                <div class="form-group">
                  <label for="vat_charge_value"><?php echo lang('Vat Charge %'); ?></label>
