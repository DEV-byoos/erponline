        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><?php echo lang('Edit Group'); ?></h3>
            </div>
            <form role="form" action="<?php base_url('admin/update_goup/') ?>" method="post">
              <div class="box-body">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createForum" <?php 
                        if($serialize_permission) {
                          if(in_array('createForum', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateForum" <?php 
                        if($serialize_permission) {
                          if(in_array('updateForum', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewForum" <?php 
                        if($serialize_permission) {
                          if(in_array('viewForum', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteForum" <?php 
                        if($serialize_permission) {
                          if(in_array('deleteForum', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                      </tr>
                      <tr>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('admin/group/') ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
