        ...
        <header>
            <div class="row">
                <div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
                    <div class="pull-left">
                        <h1 class="main-header"><span class="icon-box"><i class="fa fa-files-o"></i></span> <?=isset($settings["options"]["company"])?$settings["options"]["company"]:$settings["company"]?><?php echo isset($title)?" - ".$title:""; ?></h1>
                    </div>
                </div>
