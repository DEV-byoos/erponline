        ...
        <div id="sidebar"  class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
				...
				<?php if(in_array('updateCompany', $user_permission)): ?>
					<li><a <?=($page == "company")?'class="active"':''?> href="<?php echo base_url(); ?>admin/company"><i class="fa fa-files-o"></i><span><?=_l("Company",$this)?></span></a></li> 
				<?php endif; ?>
				...
				<li class="treeview" id="mainGroupNav">
				  ...
				  <ul class="treeview-menu">
					<?php if(in_array('createGroup', $user_permission)): ?>
					  <li id="addGroupNav"><a href="<?php echo base_url('admin/create_group') ?>"><i class="fa fa-circle-o"></i> Add Group</a></li>
					<?php endif; ?>
					<?php if(in_array('updateGroup', $user_permission) || in_array('viewGroup', $user_permission) || in_array('deleteGroup', $user_permission)): ?>
					<li id="manageGroupNav"><a href="<?php echo base_url('admin/groups') ?>"><i class="fa fa-circle-o"></i> Manage Groups</a></li>
					<?php endif; ?>
				  </ul>
				</li>
			  <?php endif; ?>

				<li><a <?=($page == "stocks")?'class="active"':''?> href="<?php echo base_url(); ?>stocks"><i class="fa fa-clock-o"></i><span><?=_l("Stocks",$this)?></span></a></li>
