	...
	*/
	public function index()
	{
		if(!in_array('viewOrder', $this->permission)) {
            redirect('stocks/dashboard', 'refresh');
        }
	...
	*/
	public function fetchOrdersData()
	{
		...
		foreach ($data as $key => $value) {
			...
			if(in_array('viewOrder', $this->permission)) {
				$buttons .= '<a target="__blank" href="'.base_url('stocks/orders/printDiv/'.$value['id']).'" class="btn btn-default"><i class="fa fa-print"></i></a>';
			}

			if(in_array('updateOrder', $this->permission)) {
				$buttons .= ' <a href="'.base_url('stocks/orders/update/'.$value['id']).'" class="btn btn-default"><i class="fa fa-pencil"></i></a>';
			}
	...
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {        	
        	...
        	if($order_id) {
        		...
        		redirect('stocks/orders/update/'.$order_id, 'refresh');
        	}
        	else {
        		$this->session->set_flashdata('errors', 'Error occurred!!');
        		redirect('stocks/orders/create/', 'refresh');
        	}
        }
        else {
            // false case
	...
	public function update($id)
	{
        ...
        if ($this->form_validation->run() == TRUE) {        	
        	...
        	if($update == true) {
        		...
        		redirect('stocks/orders/update/'.$id, 'refresh');
        	}
        	else {
        		$this->session->set_flashdata('errors', 'Error occurred!!');
        		redirect('stocks/orders/update/'.$id, 'refresh');
