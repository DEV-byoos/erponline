    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-xs-12">
          <form class="form-inline" action="<?php echo base_url('stocks/reports/') ?>" method="POST">
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><?php echo lang('Total Parking - Report'); ?></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="chart">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><?php echo lang('Total Paid Orders - Report Data'); ?>T</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="datatables" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th><?php echo lang('Month - Year'); ?></th>
