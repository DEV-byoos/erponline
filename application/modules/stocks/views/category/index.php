...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      ...
      <small><?php echo lang('Category'); ?></small>
    </h1>
    <ol class="breadcrumb">
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo lang('Manage Categories'); ?></h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo lang('Add Category'); ?></h4>
      </div>

      <form role="form" action="<?php echo base_url('stocks/category/create') ?>" method="post" id="createForm">

        <div class="modal-body">

          <div class="form-group">
            <label for="brand_name"><?php echo lang('Category Name'); ?></label>
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><?php echo lang('Edit Category'); ?></h4>
      </div>

      <form role="form" action="<?php echo base_url('stocks/category/update') ?>" method="post" id="updateForm">

        <div class="modal-body">
          <div id="messages"></div>

          <div class="form-group">
            <label for="edit_brand_name"><?php echo lang('Category Name'); ?></label>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><?php echo lang('Remove Category'); ?></h4>
      </div>

      <form role="form" action="<?php echo base_url('stocks/category/remove') ?>" method="post" id="removeForm">
        <div class="modal-body">
