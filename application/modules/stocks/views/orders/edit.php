...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      ...
      <small><?php echo lang('Orders'); ?></small>
    </h1>
    <ol class="breadcrumb">
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo lang('Edit Order'); ?></h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('stocks/orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label"><?php echo lang('Gross Amount'); ?></label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <label for="service_charge" class="col-sm-5 control-label"><?php echo lang('S-Charge'); ?><?php echo $company_data['service_charge_value'] ?> %</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <label for="net_amount" class="col-sm-5 control-label"><?php echo lang('Net Amount'); ?></label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <label for="paid_status" class="col-sm-5 control-label"><?php echo lang('Paid Status'); ?></label>
                    <div class="col-sm-7">
                      <select type="text" class="form-control" id="paid_status" name="paid_status">
                        <option value="1"><?php echo lang('Paid'); ?></option>
                        <option value="2"><?php echo lang('Unpaid'); ?></option>
                      </select>
                    </div>
                  </div>
              ...
              <div class="box-footer">
                ...
                <a target="__blank" href="<?php echo base_url() . 'stocks/orders/printDiv/'.$order_data['order']['id'] ?>" class="btn btn-default" ><?php echo lang('Print'); ?></a>
                <button type="submit" class="btn btn-primary"><?php echo lang('Save Changes'); ?></button>
                <a href="<?php echo base_url('stocks/orders/') ?>" class="btn btn-warning"><?php echo lang('Back'); ?></a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
...
<script type="text/javascript">
  ...
  //   if(id) {
  //     $.ajax({
  //       url: base_url + 'stocks/orders/printDiv/' + id,
  //       type: 'post',
  ...
  $(document).ready(function() {
    ...
    $("#add_row").unbind('click').bind('click', function() {
      ...
      $.ajax({
          url: base_url + '/stocks/orders/getTableProductRow/',
          type: 'post',
          dataType: 'json',
          success:function(response) {
  ...
  function getProductData(row_id)
  {
    ...
    if(product_id == "") {
      ...
      $.ajax({
        url: base_url + 'stocks/orders/getProductValueById',
        type: 'post',
