      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo lang('Edit Product'); ?></h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('stocks/users/update') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="product_image"><?php echo lang('Update Image'); ?></label>
                  <div class="kv-avatar">
                ...
                <div class="form-group">
                  <label for="qty"><?php echo lang('Qty'); ?></label>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('stocks/users/') ?>" class="btn btn-warning"><?php echo lang('Back'); ?></a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
