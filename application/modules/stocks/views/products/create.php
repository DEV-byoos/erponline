    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('stocks/users/create') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('stocks/products/') ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
