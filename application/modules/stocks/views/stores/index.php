...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      ...
      <small><?php echo lang('Stores'); ?></small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i><?php echo lang('Home'); ?></a></li>
      <li class="active"><?php echo lang('Stores'); ?></li>
    </ol>
  </section>
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createStore', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addModal"><?php echo lang('Add Store'); ?></button>
          <br /> <br />
        <?php endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo lang('Manage Stores'); ?></h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo lang('Add Store'); ?></h4>
      </div>

      <form role="form" action="<?php echo base_url('stocks/stores/create') ?>" method="post" id="createForm">

        <div class="modal-body">

          <div class="form-group">
            <label for="brand_name"><?php echo lang('Store Name'); ?></label>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo lang('Manage Stores'); ?>Close</button>
          <button type="submit" class="btn btn-primary"><?php echo lang('Manage Stores'); ?>Save changes</button>
        </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><?php echo lang('Edit Store'); ?></h4>
      </div>

      <form role="form" action="<?php echo base_url('stocks/stores/update') ?>" method="post" id="updateForm">

        <div class="modal-body">
          <div id="messages"></div>

          <div class="form-group">
            <label for="edit_brand_name"><?php echo lang('Store Name'); ?></label>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><?php echo lang('Remove Store'); ?></h4>
      </div>

      <form role="form" action="<?php echo base_url('stocks/stores/remove') ?>" method="post" id="removeForm">
        <div class="modal-body">
