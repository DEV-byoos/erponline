...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <?php echo lang('Manage Attributes'); ?>
      <small>Value</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i><?php echo lang('Home'); ?></a></li>
      <li class="active"><a href="<?php echo base_url('stocks/attributes/') ?>">Attributes</a></li>
  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-body">
            <h4><?php echo lang('Attribute name: ').$attribute_data['name']; ?></h4>
          </div>
        </div>
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo lang('Manage Attributes Value'); ?></h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
...
<div class="modal fade" tabindex="-1" role="dialog" id="addModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('stocks/attributes/createValue') ?>" method="post" id="createForm">
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><?php echo lang('Edit Attribute Value'); ?></h4>
      </div>

      <form role="form" action="<?php echo base_url('stocks/attributes/updateValue') ?>" method="post" id="updateForm">

        <div class="modal-body">
          <div id="messages"></div>

          <div class="form-group">
            <label for="edit_brand_name"><?php echo lang('Attribute Value'); ?></label>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><?php echo lang('Remove Attribute Value'); ?></h4>
      </div>

      <form role="form" action="<?php echo base_url('stocks/attributes/removeValue') ?>" method="post" id="removeForm">
        <div class="modal-body">
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url+'stocks/attributes/fetchAttributeValueData/'+<?php echo $attribute_data['id']; ?>,
    'order': []
  });
...
{ 
  ...
  $.ajax({
    url: base_url+'stocks/attributes/fetchAttributeValueById/'+id,
    type: 'post',
    dataType: 'json',
    success:function(response) {
